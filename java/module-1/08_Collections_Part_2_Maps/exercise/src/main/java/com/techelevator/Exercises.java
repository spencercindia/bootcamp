...
public class Exercises {
    ...
    public Map<String, Integer> consolidateInventory(Map<String, Integer> mainWarehouse,
        ...
        if (mainWarehouse.size() > remoteWarehouse.size()){
            for (Map.Entry<String, Integer> keyVal : remoteWarehouse.entrySet()) {
                if (mainWarehouse.containsKey(keyVal.getKey())) {
                    mainWarehouse.put(keyVal.getKey(), mainWarehouse.get(keyVal.getKey()) + remoteWarehouse.get(keyVal.getKey()));
                } else mainWarehouse.put(keyVal.getKey(), keyVal.getValue());
            }
            return mainWarehouse;
        } else {
            for (Map.Entry<String, Integer> keyVal : mainWarehouse.entrySet()) {
                if (remoteWarehouse.containsKey(keyVal.getKey())) {
                    remoteWarehouse.put(keyVal.getKey(), remoteWarehouse.get(keyVal.getKey()) + mainWarehouse.get(keyVal.getKey()));
                } else remoteWarehouse.put(keyVal.getKey(), keyVal.getValue());
            }
